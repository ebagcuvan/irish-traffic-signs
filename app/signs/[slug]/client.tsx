...
import { ArrowLeft, Heart, Share2, Download, ExternalLink, MapPin, Clock, AlertTriangle, Info, ArrowRight } from 'lucide-react'
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                {sign.context || 'No meaning information available for this traffic sign.'}
              </p>
            </div>
